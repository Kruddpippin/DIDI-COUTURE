...
const FALLBACK_PRODUCTS = [
  ...
  {
    id: 'dc-kaftan-maroon',
    title: '[PRE_ORDER] DIDI COUTURE Kaftan [Maroon]',
    code: 'DC_SS26_KFT_M',
    price: 'N 112,200.00',
    image: 'https://oddritualgolf.com/cdn/shop/files/CORDCAP_Maroon_F_d09ad2d0-7205-410f-b261-6eaa0be55862.jpg?v=1778057661',
    hover: 'https://oddritualgolf.com/cdn/shop/files/ODD_Navy_Back.jpg?v=1778054735',
    href: '/products/didi-couture-kaftan-maroon',
  },
  {
    id: 'dc-kaftan-sage',
    title: '[PRE_ORDER] DIDI COUTURE Kaftan [Sage]',
    code: 'DC_SS26_KFT_S',
    price: 'N 156,000.00',
    ...
    href: '/products/didi-couture-kaftan-sage',
  },
  {
    id: 'dc-cord-cap-black',
    title: '[PRE_ORDER] DIDI COUTURE Corduroy Cap [Black]',
    code: 'DC_SS26_COR_B',
    price: 'N 208,850.00',
    image: 'https://oddritualgolf.com/cdn/shop/files/DSC08915_4734c6f8-8d31-4399-949f-8c4565a6f4fc.jpg?v=1769257141',
    hover: 'https://oddritualgolf.com/cdn/shop/files/CORDCAP_Maroon_S.jpg?v=1778057505',
    href: '/products/didi-couture-corduroy-cap-black',
  },
  {
  ...
  },
  {
    ...
    title: 'DIDI COUTURE Classic Tee [Black]',
    code: 'DC_CLS_T_B',
    price: 'N 111,000.00',
    image: 'https://oddritualgolf.com/cdn/shop/files/T_BLK_MNG_B.jpg?v=1769258644',
    hover: 'https://oddritualgolf.com/cdn/shop/files/DSC08485.jpg?v=1769261658',
    href: '/products/didi-couture-classic-tee-black',
  },
  {
    id: 'dc-bomber-jacket-black',
    title: '[PRE_ORDER] DIDI COUTURE Bomber Jacket [Black]',
    code: 'DC_SS26_BMB_B',
    price: 'N 245,000.00',
    ...
    href: '/products/didi-couture-bomber-jacket-black',
  },
  {
